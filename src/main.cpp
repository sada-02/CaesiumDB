      ...
      if(FD_ISSET(currFD , &readFDs)) {
        ...
        if(isINFO) {
         response = handleINFO(isREP);
          ...
          string empFile = "";
          response = "$"+to_string(empFile.size()/8)+"\r\n"+empFile;
        }
